...
function Icon({ name, size = 20, stroke = 2, color, style, ...rest }) {
...
const FV = {
  ...
  today: {
    ...
    moveKcal: 612, moveGoal: 750,
    exerciseMin: 32, exerciseGoal: 50,
    activeHr: 9, activeGoal: 12,
  },
  metrics: {
    restingHr: { value: 54, unit: "bpm", delta: "3 bpm", dir: "down", hue: "var(--hue-heart)", icon: "heart",
      week: [58, 57, 57, 56, 55, 54, 54] },
    steps: { value: "8,240", unit: "", delta: "12%", dir: "up", hue: "var(--hue-move)", icon: "footprints",
      goal: "/ 10k", week: [6200, 9100, 7400, 12030, 8800, 6400, 8240] },
    sleep: { value: "7h 12m", unit: "", delta: "24m", dir: "up", hue: "var(--hue-sleep)", icon: "moon",
      week: [402, 418, 395, 470, 441, 388, 432] },
    spo2: { value: 97, unit: "%", delta: "stable", dir: "up", hue: "var(--hue-oxygen)", icon: "wind",
      week: [96, 97, 96, 97, 98, 97, 97] },
    energy: { value: "1,940", unit: "kcal", delta: "6%", dir: "up", hue: "var(--hue-energy)", icon: "flame",
      week: [1820, 2010, 1760, 2240, 1980, 1700, 1940] },
    hydration: { value: "1.6", unit: "L", delta: "0.4 L", dir: "down", hue: "var(--hue-hydration)", icon: "glass-water",
      goal: "/ 2.5L", week: [2.1, 2.4, 1.9, 2.6, 2.2, 1.4, 1.6] },
    hrv: { value: 62, unit: "ms", delta: "12%", dir: "up", hue: "var(--hue-mind)", icon: "activity",
      week: [52, 55, 54, 58, 60, 61, 62] },
    vo2: { value: 44, unit: "ml/kg", delta: "1", dir: "up", hue: "var(--hue-move)", icon: "gauge",
      week: [42, 42, 43, 43, 43, 44, 44] },
  },
  sleepStages: [
    { type: "Awake", min: 24, hue: "var(--hue-heart)" },
    { type: "REM", min: 96, hue: "var(--hue-mind)" },
    { type: "Light", min: 246, hue: "var(--hue-sleep)" },
    { type: "Deep", min: 66, hue: "var(--sky-400)" },
  ],
  workout: { type: "Outdoor run", icon: "footprints", dist: "5.2 km", dur: "27:41", pace: "5:19 /km", kcal: 384, hr: 156, hue: "var(--hue-move)" },
  insights: [
    { id: 1, title: "Your recovery is trending up", icon: "trending-up",
...
Object.assign(window, { Icon, FV, fmtMin, toPascal });
