...
/** Glass top bar for the chat / analysis modals. `back` shows a chevron, else ✕. */
export function ChatTopBar({ title, onClose, back = false, topInset = 0 }: { title: string; onClose: () => void; back?: boolean; topInset?: number }) {
  return (
