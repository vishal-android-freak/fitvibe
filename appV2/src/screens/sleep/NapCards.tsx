...
const styles = StyleSheet.create({
  ...
  dur: { fontFamily: font.display, fontSize: fontSize.md, lineHeight: fontSize.md, color: text.primary },
  times: { fontFamily: font.mono, fontSize: fontSize.xs, lineHeight: fontSize.md, color: text.muted, includeFontPadding: false },
  chart: { marginTop: 6 },
});
